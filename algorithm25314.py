...
n = int(input())
for i in range(n//4) : # 오답: range(n/4) X => range에 들어갈 데이터는 실수는 안되고 무조건 정수만 되나 보다
    # ex)4/4 = 1.0 or 4//4 = 1
    print('long',sep=' ',end=' ') # 주의점: sep은 문자 사이사이 공간에 넣을 것 / end는 print문 맨마지막 지점에 넣을 것을 어떻게 할지이다
print('int')